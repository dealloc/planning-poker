...
config :planning_poker, PlanningPokerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "A4vGI67juhBfBA3gmq4Q2MGilM65ks2JNKQESqfo5LjIbMBcMWhJ5cAEsG+7ykpL",
  watchers: [
...
config :planning_poker, PlanningPokerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/planning_poker_web/router\.ex$"E,
      ~r"lib/planning_poker_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
